...
# @file: test_linear_boundry.py
# @time: 2017/8/30 22:49
# @author: FunnyWu
# @license: Apache Licence 
# @contact: agiot1026@163.com
# @Software: PyCharm
import numpy as np
import DM.ClassExercises.regression.logical_regression as regression
import matplotlib.pyplot as plt
import matplotlib.ticker as mtick

if __name__ == "__main__":
    X, y = regression.loadDataSet('linear.txt')
    m, n = X.shape
    options = [{
        'rate': 0.1,
        'epsilon': 0.01,
